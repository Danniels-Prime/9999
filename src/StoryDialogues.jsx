...
export default function StoryDialogues({ voices, themeColor, onBack }) {
    ...
    <div style={{ height:'100%', display:'flex', flexDirection:'column' }}>
      ...
      <div style={{ display:'flex', alignItems:'center', gap:'10px', padding:'14px 18px 10px', flexShrink:0 }}>
        ...
        <div>
          ...
          <p style={{ fontSize:'10px', color:'#5e5c88', fontWeight:700 }}>Hear real American conversations · tap ▶ to listen</p>
        </div>
      </div>
                ...
                return (
                  <div key={i} style={{ display:'flex', justifyContent: isA ? 'flex-start' : 'flex-end' }}>
                    <div style={{
                      ...
                      <p style={{
                        fontSize:'14px', fontWeight:700, color: isCurrent ? '#fff' : '#c8c6e8', lineHeight:1.5,
